...
The collectors use the SAM.gov Get Opportunities API and the World Bank Procurement Notice dataset; the scoring layer ranks notices for tactical-training relevance.
